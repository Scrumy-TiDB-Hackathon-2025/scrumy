...
import RecentMeetings from '@/components/MeetingCard';
    ...
    <div className="flex min-h-screen bg-gray-50">      
      <div className="flex-1 flex">
        <div className="flex-1 p-8">
          <CalendarSection upcomingMeetings={upcomingMeetings} />
      ...
      {/* Status indicator for backend health */}
      {health !== 'healthy' && (
        <div className="fixed bottom-4 right-4 bg-red-500 text-white px-4 py-2 rounded-lg text-sm">
          Backend: {health}
        </div>
      )}
    </div>
